...
app.post('/disease', (req, res) => {
    const q = 'INSERT INTO disease (Disease_patient_ID, Disease_Name, Treatments) VALUES (?, ?, ?)';
...
app.put('/disease/:Disease_patient_ID', (req, res) => {
    const diseasePatientId = req.params.Disease_patient_ID;
    const q = 'UPDATE disease SET Disease_patient_ID=?, Disease_Name=?, Treatments=? WHERE Disease_patient_ID=?';
...
app.post('/has_appointment', (req, res) => {
    const q = 'INSERT INTO has_appointment (Patient_ID, Medical_ID) VALUES (?, ?)';
...
app.delete('/has_appointment/:Patient_ID/:Medical_ID', (req, res) => {
    ...
    const q = 'DELETE FROM has_appointment WHERE Patient_ID = ? AND Medical_ID = ?';
...
app.put('/has_appointment/:Patient_ID/:Medical_ID', (req, res) => {
    const patientId = req.params.Patient_ID;
    const medicalId = req.params.Medical_ID;
    const q = 'UPDATE has_appointment SET Patient_ID=?, Medical_ID=? WHERE Patient_ID=? AND Medical_ID=?';
...
app.post('/insurance', (req, res) => {
    const q = 'INSERT INTO insurance (Member_ID, Group_Number, Policy_Holder, Insurance_Provider) VALUES (?, ?, ?, ?)';
...
app.put('/insurance/:Member_ID', (req, res) => {
    const memberId = req.params.Member_ID;
    const q = 'UPDATE insurance SET Member_ID=?, Group_Number=?, Policy_Holder=?, Insurance_Provider=? WHERE Member_ID=?';
...
app.put('/is_in/:Room_Number/:Patient_ID', (req, res) => {
    const roomNumber = req.params.Room_Number;
    const patientId = req.params.Patient_ID;
    const q = 'UPDATE is_in SET Room_Number=?, Patient_ID=? WHERE Room_Number=? AND Patient_ID=?';
...
app.put('/takes_medicine/:Patient_ID/:Medicine', (req, res) => {
    const patientId = req.params.Patient_ID;
    const medicine = req.params.Medicine;
    const q = 'UPDATE takes_medicine SET Patient_ID=?, Medicine=? WHERE Patient_ID=? AND Medicine=?';
...
app.post('/tests', (req, res) => {
    const q = 'INSERT INTO tests (Test_ID, Patient_ID, Disease_Name, Test_Results, Test_Name) VALUES (?, ?, ?, ?, ?)';
...
app.put('/tests/:Test_ID', (req, res) => {
    const testId = req.params.Test_ID;
    const q = 'UPDATE tests SET Test_ID=?, Patient_ID=?, Disease_Name=?, Test_Results=?, Test_Name=? WHERE Test_ID=?';
...
app.post('/treats_for', (req, res) => {
    const q = 'INSERT INTO treats_for (Patient_ID, Disease_Name, Doctor_ID) VALUES (?, ?, ?)';
...
app.delete('/treats_for/:Patient_ID/:Disease_Name/:Doctor_ID', (req, res) => {
    ...
    const q = 'DELETE FROM treats_for WHERE Patient_ID = ? AND Disease_Name = ? AND Doctor_ID = ?';
...
app.put('/treats_for/:Patient_ID/:Disease_Name/:Doctor_ID', (req, res) => {
    ...
    const diseaseName = req.params.Disease_Name;
    const doctorId = req.params.Doctor_ID;
    const q = 'UPDATE treats_for SET Patient_ID=?, Disease_Name=?, Doctor_ID=? WHERE Patient_ID=? AND Disease_Name=? AND Doctor_ID=?';
